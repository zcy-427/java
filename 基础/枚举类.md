...
public class annotationdemo {  
    @Logannotation(level = loglevel.DEBUG,desc = "user log")  
    public static void Userlog(String name)  
    {  
        System.out.println(name+"log successfully");  
    }  
  
    public static void main(String[] args) throws NoSuchMethodException {  
        Logannotation annotation =annotationdemo.class.getMethod("Userlog",String.class).getAnnotation(Logannotation.class);  
        System.out.println("level:"+annotation.level());  
        System.out.println("desc:"+annotation.desc());  
    }  
}
```
---
